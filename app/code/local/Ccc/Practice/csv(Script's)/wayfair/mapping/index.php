...
class Data
{
        ...
        if(count($this->_data))
        {
            ...
            {      
                    ...
                    if(!isset($data[$attribute['Full Path']][$attribute['Attribute Title']]) && !empty($attribute['Attribute Title']))
                    {
                        ...
                        $this->_dataFinal[$i]['used_for_main_item'] = 0;
                        $this->_dataFinal[$i]['name_order'] = 0;
                     ...
                     $this->_optionDataFinal[$i]['sort_order'] = $attribute['Option Order'];
    ...
    public function getHeaderTitle(){
         $this->_headerTitle = array('category','attribute_title','sort_order','used_for_main_item','name_order','is_disable','important','predefined');
         return $this->_headerTitle;
    } 

    public function getOptionHeaderTitle(){
         $this->_optionHeaderTitle = array('category','attribute_title','option','sort_order','is_disable','predefined');
