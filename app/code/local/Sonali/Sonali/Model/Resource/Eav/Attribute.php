...
class Sonali_Sonali_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
     ...
     * @var string
     */
    protected $_eventPrefix                     = 'sonali_entity_attribute';
    /**
     * Event object name
     *
     * @var string
    ...
    protected function _beforeSave()
    {
        ...
        if (isset($this->_origData['is_global'])) {
            ...
            if (($this->_data['is_global'] != $this->_origData['is_global'])
                ...
                Mage::throwException(Mage::helper('sonali')->__('Scope must not be changed, because the attribute is used in configurable products.'));
            }
        }
        if ($this->getFrontendInput() == 'price') {
            if (!$this->getBackendModel()) {
                $this->setBackendModel('sonali/product_attribute_backend_price');
            }
        }
    ...
    /**
     * Register indexing event before delete sonali eav attribute
     *
     * @return Sonali_Sonali_Model_Resource_Eav_Attribute
     */
    protected function _beforeDelete()
    {
        if ($this->_getResource()->isUsedBySuperProducts($this)) {
            Mage::throwException(Mage::helper('sonali')->__('This attribute is used in configurable products.'));
        }
    ...
    /**
     * Init indexing process after sonali eav attribute delete commit
     *
     * @return Sonali_Sonali_Model_Resource_Eav_Attribute
     */
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('sonali/sonali')->getAttributesByCode();
