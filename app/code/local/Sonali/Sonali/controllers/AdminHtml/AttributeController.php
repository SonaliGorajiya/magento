...
class Sonali_Sonali_Adminhtml_AttributeController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction()
    {
        ...
        if($this->getRequest()->getParam('popup')) {
            ...
            $this->loadLayout()
                ->_setActiveMenu('sonali/attributes')
                ->_addBreadcrumb(Mage::helper('sonali')->__('sonali'), Mage::helper('sonali')->__('sonali'))
                ->_addBreadcrumb(
                    Mage::helper('sonali')->__('Manage Product Attributes'),
                    Mage::helper('sonali')->__('Manage Product Attributes'))
            ;
        }
        return $this;
    ...
    {
        $this->_initAction()
            ->_addContent($this->getLayout()->createBlock('sonali/adminhtml_attribute'))
            ->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        $item = $id ? Mage::helper('sonali')->__('Edit Product Attribute')
                    : Mage::helper('sonali')->__('New Product Attribute');

        $this->_addBreadcrumb($item, $item);

        // $this->getLayout()->getBlock('attribute_edit_js')
        //     ->setIsPopup((bool)$this->getRequest()->getParam('popup'));
        $this->_addContent($this->getLayout()->createBlock(' sonali/adminhtml_attribute_edit'))
                ->_addLeft($this->getLayout()
                ->createBlock('sonali/adminhtml_attribute_edit_tabs'));
